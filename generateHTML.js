     ...
     <body>
        <div class="wrapper">
           <div class="photo-header">
              <img src="${data.info.avatar_url}" alt="Photo of ${data.info.name}" />
              <h1>Hi!</h1>
              <h2>
              My name is ${data.info.name}!</h1>
           ...
           <main>
              ...
              <div class="row">
                 <div class="col">
                    <h3>${data.info.bio ? `${data.info.bio}` : ""}</h3>
                 </div>
                 </div>
                 <div class="row">
                 <div class="col">
                    <div class="card">
                      ...
                      <h4>${data.info.public_repos}</h4>
                    </div>
                 </div>
                  <div class="col">
                  <div class="card">
                    <h3>Followers</h3>
                    <h4>${data.info.followers}</h4>
                  </div>
                 </div>
                 </div>
                 <div class="row">
